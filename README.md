...
It provides a function to generate a CLR parser that parses your own syntax.

## syntax definition

You have to define syntax by writing rules in BNF-like notation.
...
#[derive(PartialEq, Eq, Display, EnumString, Debug, Clone, Copy, Hash)]
pub enum TokenType {
    Unknown,
    Eof,
    Id,
